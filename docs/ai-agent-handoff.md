...
- SEC-008, package split, and PERF-006 shipped in [PR #15](https://github.com/pirlruc/pixeldive/pull/15) (`03e3280`): measured uploads, production quotas, S3 put skip confirmed by HEAD, `app/rest` `app/rpc` `app/blobs` `app/sessions`, gRPC demo streams a capped chunk list, shared mobile field-1 decode
